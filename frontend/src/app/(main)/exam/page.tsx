    ...
    <div className="max-w-[1040px] mx-auto flex flex-col gap-4">
      ...
      {loadingExam ? (
        ...
        <div className="bg-white border border-emerald-100 rounded-xl p-8 text-center shadow-sm">
          ...
          <p className="text-xs text-gray-400 mt-2">응시 이력에서 결과를 확인할 수 있습니다.</p>
        </div>
      ) : (
        <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_280px] gap-4">
          ...
          <aside className="bg-white border border-black/[0.06] rounded-xl p-4 shadow-sm h-fit flex flex-col gap-4">
            <div className="flex items-center justify-between">
              <h3 className="text-sm font-black text-[#111]">답안현황</h3>
...
export default function ExamPage() {
  return (
    <Suspense fallback={<div className="flex items-center justify-center py-20 text-xs text-gray-400">불러오는 중...</div>}>
      <ExamContent />
    </Suspense>
  );
}
