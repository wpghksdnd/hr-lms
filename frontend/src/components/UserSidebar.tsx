...
export default function UserSidebar() {
  ...
  return (
    <aside className="group fixed left-0 top-14 h-[calc(100vh-3.5rem)] w-16 hover:w-56 transition-[width] duration-200 ease-in-out bg-white border-r border-black/[0.08] flex flex-col overflow-hidden z-40">
